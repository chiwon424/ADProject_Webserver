...
from .views import base_views, question_views, answer_views, comment_views, vote_views,bookmark_views
...
urlpatterns = [
    ...
    #boomark_views.py
    path('bookmark/toggle/<int:question_id>/', bookmark_views.toggle_bookmark, name='bookmark_toggle'),
    path('bookmark/list/', bookmark_views.bookmark_list, name='bookmark_list'),
    # question_views.py
